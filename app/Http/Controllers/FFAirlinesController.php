...
class FFAirlinesController extends Controller
{
    ...
    {
        $configuration ['route'] = 'app.airlines.edit';
        $configuration ['title'] = "Edit Airline record";
        $configuration['item'] = FFAirlines::find($id);
    ...
    public function adminUpdate($id)
    {
        ...
        return redirect(route('app.airlines.edit',  $record->id));
    }
